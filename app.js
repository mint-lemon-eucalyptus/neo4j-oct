...
var products = [
    {
        name: 'Мед',
        id: 1,
        photo: '/images/placeholder-274-184-1.jpg',
        photo_big: '/images/placeholder-big-1.jpg',
        price: 300,
        desc: 'Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте.',
        detailed: 'Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное.',
        package: '1 кг.',
        features: []
    },
    {
        name: 'Перга',
        id: 2,
        photo: '/images/placeholder-274-184-2.jpg',
        photo_big: '/images/placeholder-big-1.jpg',
        price: 100,
        desc: 'Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте.',
        subname: 'Тут может быть еще что-то.',
        detailed: 'Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное.',
        package: '150 г.',
        features: [
            {
                name: 'имя свойства 1',
                desc: 'и его описание свойства на 1 строку'
            },
            {
                name: 'имя свойства 2',
                desc: 'и его описание свойства на 1 строку'
    ...
    },
    {
        name: 'Пыльца',
        id: 3,
        photo: '/images/placeholder-274-184-3.jpg',
        photo_big: '/images/placeholder-big-1.jpg',
        price: 100,
        desc: 'Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте.',
        detailed: 'Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное.',
    ...
    },
    {
        ...
        id: 4,
        photo: '/images/placeholder-274-184-3.jpg',
        photo_big: '/images/placeholder-big-2.jpg',
        price: 1000,
        desc: 'Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте. Тут должно быть несколько слов о продукте.',
        detailed: 'Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное. Тут описание продукта более детальное.',
        package: '20 г.',
...
var faqs = [
    {
        id: 1,
        question: 'вопрос на 1 строку?',
        answer: 'ответ в развернутом виде. ответ в развернутом виде. ответ в развернутом виде. ответ в развернутом виде.'
    },
    {
        id: 2,
        question: 'вопрос на 1 строку?',
